...
```
pip install torch-spline-conv -f https://data.pyg.org/whl/torch-2.2.0+${CUDA}.html
```
...
```
pip install torch-spline-conv -f https://data.pyg.org/whl/torch-2.1.0+${CUDA}.html
```
